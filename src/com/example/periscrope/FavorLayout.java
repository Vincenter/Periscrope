...
public class FavorLayout extends RelativeLayout{
    ...
    private void init() {
        ...
        pink = getResources().getDrawable(R.drawable.red);
        purple = getResources().getDrawable(R.drawable.yellow);
        ...
        dHeight = pink.getIntrinsicHeight()/2;
        dWidth = pink.getIntrinsicWidth()/2;

        //底部 并且 水平居中
        lp = new LayoutParams(dHeight, dWidth);
...
//        ValueAnimator animator = ValueAnimator.ofObject(evaluator,new PointF(dx-100,dy-150),new PointF(random.nextInt(getWidth()),0));
        ValueAnimator animator = ValueAnimator.ofObject(evaluator,new PointF(dx-100,dy-150),new PointF(0,0));
